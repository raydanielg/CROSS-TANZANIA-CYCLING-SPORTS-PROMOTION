...
@section('content')
    <div class="container-fluid">
        <form action="{{ route('admin.content.testimonials.store') }}" method="POST">
            @csrf
            <div class="card card-outline card-primary shadow-sm">
                    ...
                    <div class="tab-content pt-3" id="testimonialTabContent">
                        <div class="tab-pane fade show active" id="en" role="tabpanel">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" required placeholder="e.g. Juma Hamisi">
                            </div>
                            <div class="form-group">
                                <label for="role">Role/Description (EN)</label>
                                <input type="text" name="role" class="form-control" placeholder="e.g. Professional Cyclist">
                            </div>
                            <div class="form-group">
                                <label for="content">Testimonial Content (EN)</label>
                                <textarea name="content" class="form-control" rows="5" required placeholder="What did they say?"></textarea>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="sw" role="tabpanel">
                            <div class="form-group">
                                <label for="role_sw">Role/Description (SW)</label>
                                <input type="text" name="role_sw" class="form-control" placeholder="mfano: Mwendesha Baiskeli wa Kulipwa">
                            </div>
                            <div class="form-group">
                                <label for="content_sw">Testimonial Content (SW)</label>
                                <textarea name="content_sw" class="form-control" rows="5" placeholder="Alisema nini?"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-footer text-right">
                    ...
                    <button type="submit" class="btn btn-primary shadow-sm">Save Testimonial</button>
                </div>
            </div>
        </form>
    </div>
