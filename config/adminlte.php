        ...
        [
            ...
            'submenu' => [
                ...
                [
                    ...
                    'url' => '#',
                    'submenu' => [
                        ['text' => 'M-Pesa', 'url' => 'admin/payments/methods/mpesa'],
                        ['text' => 'Tigo Pesa', 'url' => 'admin/payments/methods/tigopesa'],
                        ['text' => 'Airtel Money', 'url' => 'admin/payments/methods/airtel'],
                        ['text' => 'HaloPesa', 'url' => 'admin/payments/methods/halopesa'],
                        ['text' => 'Bank Transfers', 'url' => 'admin/payments/methods/bank'],
                        ['text' => 'Visa/Mastercard', 'url' => 'admin/payments/methods/card'],
                    ],
                ],
            ],
        ],
